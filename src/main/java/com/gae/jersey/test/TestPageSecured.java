...
@Path(value = "/securedtest.jsp")
@Produces(value = { "text/html" })
@PermitAll
public class TestPageSecured implements Serializable {

	private static final Logger logger = Logger.getLogger(TestPageSecured.class.getName());
